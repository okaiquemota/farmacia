...
(function (janela, documento) {
  ...
  function vantagens() {
    var itens = [
      ['caminhao', 'Frete grátis', 'acima de ' + L.moeda(D.config.freteGratisAcima)],
      ['relogio', 'Entrega em 2h', 'nas capitais e regiões metropolitanas'],
      ['chat', 'Farmacêutico online', 'tire dúvidas de segunda a sábado'],
  ...
  function prateleiraDestaques() {
    ...
    return '<section class="secao"><div class="secao__cabecalho">' +
      '<div><h2>Mais vendidos da semana</h2><p>Os favoritos de quem compra na Bem Viver</p></div>' +
      ...
      '<div style="position:relative;border-radius:var(--r-lg);overflow:hidden">' +
        ...
        '<div style="position:absolute;inset:0;display:flex;flex-direction:column;justify-content:center;' +
          ...
          '<span class="selo" style="background:rgba(255,255,255,.18);color:#fff;align-self:flex-start">' +
            'Gratuito</span>' +
          '<h2 style="font-size:28px">Clube Bem Viver: até 15% de desconto em todo o site</h2>' +
  ...
  function montar() {
    ...
    documento.addEventListener('click', function (e) {
      if (e.target.closest('[data-assinar-clube]')) {
        L.aviso('Cadastro do Clube Bem Viver realizado! Os preços de clube já estão aplicados.', 'ok');
      }
    });
  }
